...
def book_detail(request, pk):
    ...
    available_copies = copies.filter(status='a')  # Filter available copies
...
class BookCreate(CreateView):
    model = Book
    fields = ['title', 'author', 'isbn', 'book_image']
...
def book_delete(request, pk):
    ...
    try:
        ...
        messages.error(request, f'{book.title} cannot be deleted. Authors exist for this book.')
